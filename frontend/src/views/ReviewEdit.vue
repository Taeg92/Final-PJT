<template>
  <div>
    ...
    <div class="create-review container">
      <h3 class="text-light font-weight-bold mb-4">리뷰 수정</h3>
      <div class="row">
        <div class="col-sm-4">
        ...
        <div class="col-sm-8">
          <div>
            <input
              ...
              type="text"
            />
            <small><span class="text-muted d-block my-1">수정할 제목을 입력해주세요.</span></small>
          </div>
          <div>
            <textarea
              class="form-control"
              ...
              rows="7"
            />
            <small><span class="text-muted d-block mt-1">수정할 리뷰 내용을 입력해주세요.</span></small>
          </div>
          <div class="my-3">
            ...
            <small><span class="text-muted d-block mt-2">수정할 평점을 입력해주세요.</span></small>
          </div>
          <button class="form-control btn-danger mt-5" @click="submitReviewEdit(submitInfo)">리뷰 수정</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions(["getReviewDetail", "submitReviewEdit", "getMovieDetail"]),
    changeURL() {
